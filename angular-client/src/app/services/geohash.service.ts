/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
/** Geohash encoding/decoding and associated functions by Chris Veness 2014
 *  / Github: chrisveness
 *  / MIT Licence
...
export class GeohashService {
   ...
   */
  public encode(lat, lon, precision) {
    // infer precision?
   ...
   * @throws  Invalid geohash.
   */
  public adjacent(geohash, direction) {
